...
import com.kdn.data.remote.datasource.goods.RemoteGoodsDataSourceImpl
import dagger.Binds
...
abstract class RemoteDataSourceModule {
    ...
    @Binds
    abstract fun provideRemoteGoodsDataSource(
        remoteGoodsDataSourceImpl: RemoteGoodsDataSourceImpl,
    )
}